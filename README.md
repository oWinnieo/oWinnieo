...
我觉得 TA 身上最特别的地方，是一种**认真而顽固的浪漫**。TA 会为了一个角色走路时脚尖的方向反复调整，也会为了系统真正可靠地运行去追查最不起眼的问题。比起让 AI 看起来无所不能，TA 更想知道：怎样让它变得可理解、可观察、可陪伴，也更像一个生活在世界里的存在。
...
- 把 AI Agent 从抽象对话变成拥有角色、动作、环境与故事的可见存在。
- 探索像素世界、游戏交互和 Agent 工作流之间的新连接。
- 用快速原型验证想法，再把真正有生命力的部分认真做完。
